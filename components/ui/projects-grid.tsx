...
export const ProjectsGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid md:auto-rows-[18rem] grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto font-geist-mono",
        className
      )}
    >
      {children}
  ...
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        {icon}
        <div className="text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
          {title}
        </div>
